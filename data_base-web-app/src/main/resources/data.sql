...
CREATE TABLE ticket(
    ...
    flight_id bigint DEFAULT 0,
    passenger_id bigint DEFAULT 0,
    seat_id bigint default 0,
...
INSERT INTO users (login, password, enabled, first_name, second_name, email, phone_number)
VALUES ('admin', '$2a$10$73dQALAYAHPjOZdIqObi4u5jUZ2Tqg2Mzr4pPk5AHRaKFm/jBEhwK', true, 'sasha', 'sakahruk', 'sakharukaliaksandr@gmail.com', 292001211);
INSERT INTO users (login, password, enabled, first_name, second_name, email, phone_number)
VALUES ('editor', '$2a$10$Y4uw8pVXJ19lvYKUHehyuunVjPBdaU7OEOqgxKBKgVGbWSb.rTYrC', true, 'petia', 'olejnik', 'olejnik@gmail.com', 292112121);
INSERT INTO users (login, password, enabled, first_name, second_name, email, phone_number)
VALUES ('sasha', '$2a$10$dOSLyd3hnCQTqEn1qOxxCudCzFWw9Mmrw7wqwYuPRHVGXvCwCp5NK', true, 'sasha', 'sakahruk', 'sakharukaliaksandr@gmail.com', 292001211);
INSERT INTO users (login, password, enabled, first_name, second_name, email, phone_number)
VALUES ('roma', '$2a$10$n7iTfbubVVoJn/OmEpbC2el.tHTYjeAHHB8jrQecxbUHe5lalmvR.', true, 'roma', 'salapura', 'salapurar@gmail.com', 297229238);
...
INSERT INTO flight(number_flight, arrive_city, arrive_date_time, duration_flight, departure_city, departure_date_time, plane_id)
values('FK256', 'BREST', '2021-10-01 14:00:00', 50, 'GOMEL', '2021-10-01 14:50:00', 1);
INSERT INTO flight(number_flight, arrive_city, arrive_date_time, duration_flight, departure_city, departure_date_time, plane_id)
values('FK333', 'BREST', '2021-10-01 14:00:00', 45, 'MINSK', '2021-10-01 14:45:00', 2);
INSERT INTO flight(number_flight, arrive_city, arrive_date_time, duration_flight, departure_city, departure_date_time, plane_id)
values('FK123', 'MINSK', '2021-10-01 16:00:00', 60, 'MOSCOW', '2021-10-01 17:00:00', 3);
INSERT INTO flight(number_flight, arrive_city, arrive_date_time, duration_flight, departure_city, departure_date_time, plane_id)
values('FK777', 'BREST', '2021-10-01 19:00:00', 80, 'MOSCOW', '2021-10-01 20:20:00', 4);
...
INSERT INTO PASSENGER(first_name, second_name, passport_number, phone_number, address_id, user_id)
...
INSERT INTO ticket(flight_id, passenger_id, seat_id)
values(1, 1, 1);
INSERT INTO ticket(flight_id, passenger_id, seat_id)
values(2, 2, 49);
INSERT INTO ticket(flight_id, passenger_id, seat_id)
